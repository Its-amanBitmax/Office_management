...
@section('page-title', 'Create Interaction')
@section('page-description', 'Add a new interaction for a lead')
            ...
            <div class="card-body">
                <form action="{{ route('admin.interactions.store') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control @error('lead_id') is-invalid @enderror" id="lead_id" name="lead_id" required>
                                    ...
                                    @foreach($leads as $lead)
                                        <option value="{{ $lead->id }}" {{ (old('lead_id') == $lead->id || (isset($leadId) && $leadId == $lead->id)) ? 'selected' : '' }}>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-control @error('activity_type') is-invalid @enderror" id="activity_type" name="activity_type" required>
                                    ...
                                    <option value="WhatsApp" {{ old('activity_type') == 'WhatsApp' ? 'selected' : '' }}>WhatsApp</option>
                                    ...
                                    <option value="Note" {{ old('activity_type') == 'Note' ? 'selected' : '' }}>Note</option>
                                </select>
                                @error('activity_type')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-control @error('activity_status') is-invalid @enderror" id="activity_status" name="activity_status" required>
                                    <option value="Pending" {{ old('activity_status', 'Pending') == 'Pending' ? 'selected' : '' }}>Pending</option>
                                    <option value="Completed" {{ old('activity_status') == 'Completed' ? 'selected' : '' }}>Completed</option>
                                </select>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control @error('next_follow_up') is-invalid @enderror" id="next_follow_up" name="next_follow_up" value="{{ old('next_follow_up') }}">
                    ...
                    <div class="d-flex gap-2">
                        <button type="submit" class="btn btn-primary">
                            <i class="fas fa-save"></i> Create Interaction
                        </button>
